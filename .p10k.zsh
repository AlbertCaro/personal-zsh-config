# Generated by Powerlevel10k configuration wizard on 2024-03-26 at 01:22 CST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 04117.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, slanted separators, blurred heads, round tails, 2 lines, dotted, no frame,
# darkest-ornaments, sparse, many icons, fluent, instant_prompt=verbose.
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='󰂩 Alberto Caro'
